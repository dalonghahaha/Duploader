...
Duploader.prototype.file_add_show = function(file_info){
    ...
    var section_file_list = document.getElementById(this.config.section_file_list);
    ...
    if(section_file_list){
        ...
        if(this.config.multiple){
            ...
            btn_change.addEventListener("click",this.file_change.bind(this));
            btn_delete.addEventListener("click",this.file_remove.bind(this));
        }
    }
}
